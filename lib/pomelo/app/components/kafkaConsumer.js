    ...
    this._consumer.consumeMessage(topics, (err, message) => {
        ...
        switch (message.topic) {
            case "data-source-config":
                ...
                let configTopic = parse.parseDataSourceConfigMqttTopicFromKafka(data);
                ...
                let msg = {
                    ...
                    dup: false,
                    topic: configTopic,
                    payload: JSON.stringify(data.configs),
                };
                channel.pushMessage(msg, (err) => {
                    ...
                    logger.info(`data source: ${data.dataSourceID} consume topic: "${configTopic}" success`, traceContext);
                });
                return;
            default:
